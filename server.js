...
const PORT = 5001;
app.listen(PORT, () => {
  console.log(`Escuchando servidor en el puerto local ${PORT}`);;
})
const rutaUsuarios = require('./app/routes/usuarios');
const rutaBootcamps = require('./app/routes/bootcamps.js');   


// API Usuarios
app.use("/api/usuarios", rutaUsuarios);
// API Bootcamps
app.use("/api/bootcamps", rutaBootcamps);
...
const usarDatos = () => db.sequelize.sync()

const cargarDatos = () => db.sequelize.sync({
  force: true
}).then(() => {
